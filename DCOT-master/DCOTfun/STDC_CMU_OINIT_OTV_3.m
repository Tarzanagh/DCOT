function [V,Core,info,X,itr] = STDC_CMU_OINIT_OTV_3(X,mark,para_ST,Xg,src_type,B_SVD)
...
if ~isfield(para_ST,'VSet')
    ...
    para_ST.H = my123construct_graphL(tsize,para_ST.VSet,para_ST.Rate,para_ST.gnns,para_ST.Affinity);
...
for itr = 1 : para_ST.maxitr
    ...
    % update Z   
    Z = optimize_l2Z(Z,V,X,Y,ita,para_ST.gamma);
    % update X
