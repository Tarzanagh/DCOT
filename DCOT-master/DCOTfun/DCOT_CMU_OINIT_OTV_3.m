function [V,Core,info,X,itr] = DCOT_CMU_OINIT_OTV_3(X,mark,para_ST,Xg,src_type,B_SVD)
...
if ~isfield(para_ST,'VSet')
    ...
    para_ST.H = my3construct_graphL(tsize,para_ST.VSet,para_ST.Rate,para_ST.gnns,para_ST.Affinity);
